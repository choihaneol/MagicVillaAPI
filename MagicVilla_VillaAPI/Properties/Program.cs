...
builder.Services.AddSwaggerGen(option => {
    ...
    //Security Definition (Bearer선언 : Postman에서 header에 key 입력하는것과 같음)
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "Magic_VillaV1"); //"title밑","toggle"
...
app.UseAuthentication(); //It shuuld be add before app.UseAuthorizatoin()
